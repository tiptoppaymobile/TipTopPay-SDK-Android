...
internal class GooglePayHandler {
	companion object {
		fun present(configuration: PaymentConfiguration, gateway: String, activity: PaymentActivity, requestCode: Int) {
		...
		private fun createPaymentDataRequest(transactionInfo: TransactionInfo, publicId: String, gateway: String,): PaymentDataRequest {
