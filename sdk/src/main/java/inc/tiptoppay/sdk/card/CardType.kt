...
enum class CardType {
	...
	fun getIconRes(): Int? = when (this) {
		VISA -> R.drawable.ttpsdk_ic_ps_visa
		MASTER_CARD -> R.drawable.ttpsdk_ic_ps_mastercard
		MAESTRO -> R.drawable.ttpsdk_ic_ps_maestro
		MIR -> R.drawable.ttpsdk_ic_ps_mir
		JCB -> R.drawable.ttpsdk_ic_ps_jcb
		else -> null
	}
}